...
Monoid는 triple(T, __\*__, *e*) 이라고도 정의하는데, 어떤 type T에 대하여 결합법칙을 만족하는 이항연산자 _\*_가 있고 항등원 *e*가 있음을 뜻합니다.
